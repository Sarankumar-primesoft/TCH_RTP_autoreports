...
public class Reports_AdministrationRequestTest extends BaseClass{
	...
	@Test
	public void AdministrationRequestTest_TCH() throws InterruptedException
	{
		ExtentReport.createTest("Administration Request Reporting Summary TCH Test");
		...
		for (String reportType : reportTypesFromConfig) {
			...
			clickelementwithname(acreport.selectReportType, "Reopening Administration Request dropdown");
